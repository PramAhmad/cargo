<x-app-layout>
    ...
    <div class="space-y-4">
        ...
        <div class="flex flex-col items-center justify-between gap-y-4 md:flex-row md:gap-y-0">
            ...
            <form
                action="{{ route('marketing-groups.index') }}"
                method="GET"
                ...
                @if(isset($search) && !empty($search))
                    <div class="flex h-full items-center px-2">
                        <a href="{{ route('marketing-groups.index') }}" class="text-slate-400 hover:text-danger-500">
        ...
        <div class="flex items-center text-sm text-slate-500 dark:text-slate-400 mb-2">
            ...
            <a href="{{ route('marketing-groups.index') }}" class="ml-2 text-xs text-danger-500 hover:underline">
                Clear search
            </a>
        </div>
        @endif
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="4" class="text-center py-4">
                            @if(isset($search) && !empty($search))
                                No marketing groups found matching "{{ $search }}"
                            @else
