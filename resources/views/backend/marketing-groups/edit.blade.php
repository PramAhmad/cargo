<x-app-layout>
    <!-- Page Title Starts -->
    <x-page-title header="Edit Marketing Group" page="Marketing" />
    <!-- Page Title Ends -->
    ...
    <div class="space-y-6">
        <div class="card">
            <div class="card-body p-6">
                ...
                <form action="{{ route('marketing-groups.update', $marketingGroup->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="grid w-full grid-cols-1 gap-4 py-2 md:grid-cols-2">
                        <div class="flex w-full flex-col md:w-auto">
                            ...
                            <input type="text" class="input" id="name" name="name" value="{{ $marketingGroup->name }}" />
                        </div>
                    </div>
