                                ...
                                <div class="flex flex-col gap-1 mb-4">
                                    ...
                                    <div class="relative">
                                        <input type="text" class="input pl-10 price-input" id="mit_price_cbm_display" 
                                               value="{{ old('mit_price_cbm', '0') }}" data-target="mit_price_cbm" readonly />
                                ...
                                <div class="flex flex-col gap-1">
                                    ...
                                    <div class="relative">
                                        <input type="text" class="input pl-10 price-input" id="cust_price_cbm_display" 
                                               value="{{ old('cust_price_cbm', '0') }}" data-target="cust_price_cbm" readonly />
                                ...
                                <div class="flex flex-col gap-1 mb-4">
                                    ...
                                    <div class="relative">
                                        <input type="text" class="input pl-10 price-input" id="mit_price_kg_display" 
                                               value="{{ old('mit_price_kg', '0') }}" data-target="mit_price_kg" readonly />
                                ...
                                <div class="flex flex-col gap-1">
                                    ...
                                    <div class="relative">
                                        <input type="text" class="input pl-10 price-input" id="cust_price_kg_display" 
                                               value="{{ old('cust_price_kg', '0') }}" data-target="cust_price_kg" readonly />
        ...
        $(document).ready(function() {
            ...
            $('#category_product_id').on('change', function() {
                ...
                if ($selected.val()) {
                    ...
                    $('#mit_price_cbm').val(mitPriceCbm);
                    $('#mit_price_kg').val(mitPriceKg);
                    $('#cust_price_cbm').val(custPriceCbm);
                    $('#cust_price_kg').val(custPriceKg);
                } else {
                    ...
                    $('#mit_price_cbm, #mit_price_kg, #cust_price_cbm, #cust_price_kg').val('0');
                }
            });
