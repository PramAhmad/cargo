                            ...
                            <select id="category_product_id" name="category_product_id" class="select">
                                ...
                                @foreach($categories as $category)
                                    <option value="{{ $category->id }}" 
                                        ...
                                        {{ $category->name }} ({{ $category->mitra->name }})
                                    </option>
                                @endforeach
                            </select>
                                        ...
                                        <div class="flex flex-col gap-1 mb-4">
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="text" class="input pl-10 price-input" id="mit_price_cbm_sea_display" 
                                                      value="{{ old('mit_price_cbm_sea', '0') }}" data-target="mit_price_cbm_sea" readonly />
                                                <input type="hidden" name="mit_price_cbm_sea" id="mit_price_cbm_sea" value="{{ old('mit_price_cbm_sea', '0') }}" />
                                        ...
                                        <div class="flex flex-col gap-1">
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="text" class="input pl-10 price-input" id="cust_price_cbm_sea_display" 
                                                      value="{{ old('cust_price_cbm_sea', '0') }}" data-target="cust_price_cbm_sea" readonly />
                                                <input type="hidden" name="cust_price_cbm_sea" id="cust_price_cbm_sea" value="{{ old('cust_price_cbm_sea', '0') }}" />
                                                <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                                                    <span class="text-xs text-slate-400">From Category</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="flex flex-col gap-1 mb-4">
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="text" class="input pl-10 price-input" id="mit_price_kg_sea_display" 
                                                      value="{{ old('mit_price_kg_sea', '0') }}" data-target="mit_price_kg_sea" readonly />
                                                <input type="hidden" name="mit_price_kg_sea" id="mit_price_kg_sea" value="{{ old('mit_price_kg_sea', '0') }}" />
                                                <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                                                    <span class="text-xs text-slate-400">From Category</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="flex flex-col gap-1">
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="text" class="input pl-10 price-input" id="cust_price_kg_sea_display" 
                                                      value="{{ old('cust_price_kg_sea', '0') }}" data-target="cust_price_kg_sea" readonly />
                                                <input type="hidden" name="cust_price_kg_sea" id="cust_price_kg_sea" value="{{ old('cust_price_kg_sea', '0') }}" />
                                                <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                                                    <span class="text-xs text-slate-400">From Category</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="flex flex-col gap-1 mb-4">
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="text" class="input pl-10 price-input" id="mit_price_cbm_air_display" 
                                                      value="{{ old('mit_price_cbm_air', '0') }}" data-target="mit_price_cbm_air" readonly />
                                                <input type="hidden" name="mit_price_cbm_air" id="mit_price_cbm_air" value="{{ old('mit_price_cbm_air', '0') }}" />
                                                <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                                                    <span class="text-xs text-slate-400">From Category</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="flex flex-col gap-1">
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="text" class="input pl-10 price-input" id="cust_price_cbm_air_display" 
                                                      value="{{ old('cust_price_cbm_air', '0') }}" data-target="cust_price_cbm_air" readonly />
                                                <input type="hidden" name="cust_price_cbm_air" id="cust_price_cbm_air" value="{{ old('cust_price_cbm_air', '0') }}" />
                                                <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                                                    <span class="text-xs text-slate-400">From Category</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="flex flex-col gap-1 mb-4">
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="text" class="input pl-10 price-input" id="mit_price_kg_air_display" 
                                                      value="{{ old('mit_price_kg_air', '0') }}" data-target="mit_price_kg_air" readonly />
                                                <input type="hidden" name="mit_price_kg_air" id="mit_price_kg_air" value="{{ old('mit_price_kg_air', '0') }}" />
                                                <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                                                    <span class="text-xs text-slate-400">From Category</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="flex flex-col gap-1">
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="text" class="input pl-10 price-input" id="cust_price_kg_air_display" 
                                                      value="{{ old('cust_price_kg_air', '0') }}" data-target="cust_price_kg_air" readonly />
                                                <input type="hidden" name="cust_price_kg_air" id="cust_price_kg_air" value="{{ old('cust_price_kg_air', '0') }}" />
                                                <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                                                    <span class="text-xs text-slate-400">From Category</span>
                                                </div>
                                            </div>
