                ...
                <form action="{{ route('category-products.update', $categoryProduct->id) }}" method="POST">
                    ...
                    <div class="grid w-full grid-cols-1 gap-4 py-2 md:grid-cols-2">
                        <div class="flex w-full flex-col md:w-auto">
                            ...
                            <input type="text" class="input" id="name" name="name" value="{{ old('name', $categoryProduct->name) }}" required />
                        </div>
                                    ...
                                    <div class="flex w-full flex-col md:w-auto">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" class="input pl-10 price-input" id="mit_price_cbm_sea" name="mit_price_cbm_sea" 
                                                value="{{ old('mit_price_cbm_sea', $categoryProduct->mit_price_cbm_sea) }}" required />
                                            <input type="hidden" id="mit_price_cbm_sea_raw" name="mit_price_cbm_sea_raw" value="{{ $categoryProduct->mit_price_cbm_sea }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex w-full flex-col md:w-auto">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" class="input pl-10 price-input" id="mit_price_kg_sea" name="mit_price_kg_sea" 
                                                value="{{ old('mit_price_kg_sea', $categoryProduct->mit_price_kg_sea) }}" required />
                                            <input type="hidden" id="mit_price_kg_sea_raw" name="mit_price_kg_sea_raw" value="{{ $categoryProduct->mit_price_kg_sea }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex w-full flex-col md:w-auto">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" class="input pl-10 price-input" id="cust_price_cbm_sea" name="cust_price_cbm_sea" 
                                                value="{{ old('cust_price_cbm_sea', $categoryProduct->cust_price_cbm_sea) }}" required />
                                            <input type="hidden" id="cust_price_cbm_sea_raw" name="cust_price_cbm_sea_raw" value="{{ $categoryProduct->cust_price_cbm_sea }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex w-full flex-col md:w-auto">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" class="input pl-10 price-input" id="cust_price_kg_sea" name="cust_price_kg_sea" 
                                                value="{{ old('cust_price_kg_sea', $categoryProduct->cust_price_kg_sea) }}" required />
                                            <input type="hidden" id="cust_price_kg_sea_raw" name="cust_price_kg_sea_raw" value="{{ $categoryProduct->cust_price_kg_sea }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="flex w-full flex-col md:w-auto">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" class="input pl-10 price-input" id="mit_price_cbm_air" name="mit_price_cbm_air" 
                                                value="{{ old('mit_price_cbm_air', $categoryProduct->mit_price_cbm_air) }}" required />
                                            <input type="hidden" id="mit_price_cbm_air_raw" name="mit_price_cbm_air_raw" value="{{ $categoryProduct->mit_price_cbm_air }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex w-full flex-col md:w-auto">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" class="input pl-10 price-input" id="mit_price_kg_air" name="mit_price_kg_air" 
                                                value="{{ old('mit_price_kg_air', $categoryProduct->mit_price_kg_air) }}" required />
                                            <input type="hidden" id="mit_price_kg_air_raw" name="mit_price_kg_air_raw" value="{{ $categoryProduct->mit_price_kg_air }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex w-full flex-col md:w-auto">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" class="input pl-10 price-input" id="cust_price_cbm_air" name="cust_price_cbm_air" 
                                                value="{{ old('cust_price_cbm_air', $categoryProduct->cust_price_cbm_air) }}" required />
                                            <input type="hidden" id="cust_price_cbm_air_raw" name="cust_price_cbm_air_raw" value="{{ $categoryProduct->cust_price_cbm_air }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex w-full flex-col md:w-auto">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" class="input pl-10 price-input" id="cust_price_kg_air" name="cust_price_kg_air" 
                                                value="{{ old('cust_price_kg_air', $categoryProduct->cust_price_kg_air) }}" required />
                                            <input type="hidden" id="cust_price_kg_air_raw" name="cust_price_kg_air_raw" value="{{ $categoryProduct->cust_price_kg_air }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
